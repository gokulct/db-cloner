...
- The pom.xml file is configured to create a .exe file using the Launch4j plugin (run the command 'mvn clean package' to build the project, This will create the .exe file in the target folder.)
